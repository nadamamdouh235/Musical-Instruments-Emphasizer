...
guitar_photo = PhotoImage(file=r"images/guitaricon.png")
...
piano_photo = PhotoImage(file=r"images/piano.png")
...
drums_photo = PhotoImage(file=r"images/drums.png")
...
violin_photo = PhotoImage(file=r"images/violin.png")
...
organ_photo = PhotoImage(file=r"images/organ.png")
...
start_photo = PhotoImage(file=r'images/start1.png')
pause_photo = PhotoImage(file=r'images/pause3.png')
...
piano_button_image = PhotoImage(file=r'images/piano button.png')
...
xylophone_bf_resize = ImageTk.PhotoImage(file="images/xylophone9.png")
...
xylophone_button_image = PhotoImage(file=r'images/xylophone button.png')
...
drums_bf_resize = ImageTk.PhotoImage(file="images/drum3.png")
...
drums_button_image = PhotoImage(file=r'images/drums button.png')
...
def resize(self):
    ...
    xylophone_tobe_resized = Image.open("images/xylophone8.png")
    ...
    # open image to resize it
    drums_tobe_resized = Image.open("images/drum3.png")
